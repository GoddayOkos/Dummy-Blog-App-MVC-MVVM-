...
import dev.decagon.godday.mvvm.adapter.PostAdapter
import dev.decagon.godday.mvvm.model.Post
import dev.decagon.godday.mvvm.viewmodel.PostViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
         ...
         */
        viewModel = ViewModelProvider(this, PostViewModel.Factory(this.application))
